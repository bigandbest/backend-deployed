...
const transformProduct = (product, assignments = []) => {
  ...
  return {
    ...
    brand_id: product.brands?.[0]?.brand?.id || null,
  ...
  try {
    ...
    const responseBody = {
      ...
      product: {
        ...
        store_id: product.store_id || product.product_recommended_store?.[0]?.recommended_store?.id || null,
        store_name: product.store?.name || product.product_recommended_store?.[0]?.recommended_store?.name || null,
        brand_id: product.brand_id || product.brands?.[0]?.brand?.id || null,
