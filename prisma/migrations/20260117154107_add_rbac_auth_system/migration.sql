...
CREATE TABLE "products" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "vertical" "Vertical" NOT NULL DEFAULT 'grocery',
    "category_id" UUID,
    "subcategory_id" UUID,
    "group_id" UUID,
    "image" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "variant_attributes_variant_id_attribute_name_key" ON "variant_attributes"("variant_id", "attribute_name");
...
-- AddForeignKey
ALTER TABLE "recommended_store" ADD CONSTRAINT "recommended_store_banner_id_fkey" FOREIGN KEY ("banner_id") REFERENCES "add_banner"("id") ON DELETE SET NULL ON UPDATE CASCADE;
